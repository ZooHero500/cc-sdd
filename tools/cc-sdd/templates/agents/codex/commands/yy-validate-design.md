...
### Error Scenarios
- **Missing Design**: If design.md doesn't exist, stop with message: "Run `/prompts:yy-spec-design $1` first to generate design document"
...
- Run `/prompts:yy-spec-tasks $1` to generate implementation tasks
- Or `/prompts:yy-spec-tasks $1 -y` to auto-approve and proceed directly

**If Design Needs Revision (NO-GO Decision)**:
- Address critical issues identified
- Re-run `/prompts:yy-spec-design $1` with improvements
- Re-validate with `/prompts:yy-validate-design $1`
