...
### Error Scenarios
- **Missing Requirements**: If requirements.md doesn't exist, stop with message: "Run `/prompts:yy-spec-requirements $1` first to generate requirements"
...
- Run `/prompts:yy-spec-design $1` to create technical design document
- Or `/prompts:yy-spec-design $1 -y` to auto-approve requirements and proceed directly
