...
- Parse conversation history for `/prompts:yy-spec-impl <feature> [tasks]` commands
...
## Tool Guidance
- **Conversation parsing**: Extract `/prompts:yy-spec-impl` patterns from history
...
### Error Scenarios
- **No Implementation Found**: If no `/prompts:yy-spec-impl` in history and no `[x]` tasks, report "No implementations detected"
...
- Re-run `/prompts:yy-spec-impl <feature> [tasks]` for fixes
- Re-validate with `/prompts:yy-validate-impl [feature] [tasks]`
