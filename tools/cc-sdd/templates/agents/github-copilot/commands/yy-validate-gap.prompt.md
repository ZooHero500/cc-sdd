...
### Error Scenarios
- **Missing Requirements**: If requirements.md doesn't exist, stop with message: "Run `/yy-spec-requirements $1` first to generate requirements"
...
- Run `/yy-spec-design $1` to create technical design document
- Or `/yy-spec-design $1 -y` to auto-approve requirements and proceed directly
